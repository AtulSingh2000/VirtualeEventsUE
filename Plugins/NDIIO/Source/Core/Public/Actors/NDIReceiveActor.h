...
private:
	...
	*/
	UPROPERTY(EditInstanceOnly, BlueprintSetter = "UpdateAudioPlayback", Category = "NDI IO|Media",
	...
	UPROPERTY(BlueprintReadWrite, EditInstanceOnly, Category = "NDI IO|Media",
